...
const regexChars = /\W|_/g;
let errorMessage = '';
export const signInValidation = (error, password, email) => {
  switch (true) {
    case !email:
    ...
    case error.code === 'auth/user-not-found':
      errorMessage = "Account doesn't exist, please create an account to login";
    default:
      break;
  }
...
export const signUpValidation = (error, password, email, fullName) => {
  switch (true) {
    case !fullName:
